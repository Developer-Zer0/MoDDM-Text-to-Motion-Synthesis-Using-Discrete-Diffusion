...
from src.models.utils.model_utils import PositionalEncoding, lengths_to_mask

class DistilbertActorAgnosticEncoder(DistilBERTEncoder):
    def __init__(self, modelpath: str,
        ...
        super().__init__(modelpath=modelpath, finetune=finetune, latent_dim=latent_dim)
